		...
		((e) => {
							...
							if (
								...
								var e = (e, t, n, i) =>
									...
									t = (t, n, i, a) => {
										...
										if ("number" == typeof t) var o = Number.parseInt(t);
										else
											var o = ((e, t) =>
												"HTML" === e.nodeName
													? -t
													: e.getBoundingClientRect().top + t)(t, r);
										var s = Date.now(),
											l =
			...
			(e, t, n) => {
				...
				var i = (() => {
						...
						return (t, n, i) => (n && e(t.prototype, n), i && e(t, i), t);
					})(),
					a = s(n(1)),
					r = s(n(0)),
					o = s(n(5));
						...
						i(e, [
							{
								...
								value: function () {
									this.player.template.list.addEventListener("click", (t) => {
										...
										i !== this.index
											? (this.switch(i), this.player.play())
											: this.player.toggle();
									});
								},
							},
							...
							},
							{
								...
								value: function () {
									this.player.events.trigger("listhide"),
										this.player.template.list.classList.add(
											"aplayer-list-hide",
										);
								},
							},
							...
							},
							{
								...
								value: function () {
									...
									this.loadingChecker = setInterval(() => {
										this.enableloadingChecker &&
											((n = this.player.audio.currentTime),
											i ||
												n !== t ||
								...
								value: function () {
									this.types.forEach((t) => {
										(this["enable" + t + "Checker"] = !1),
											this[t + "Checker"] && clearInterval(this[t + "Checker"]);
									});
								},
							},
						]),
							...
							},
							{
								...
								value: function () {
									this.player.template.order.addEventListener("click", () => {
										"list" === this.player.options.order
											? ((this.player.options.order = "random"),
												(this.player.template.order.innerHTML =
								...
								value: function () {
									this.player.template.loop.addEventListener("click", () => {
										this.player.list.audios.length > 1
											? "one" === this.player.options.loop
												? ((this.player.options.loop = "none"),
													(this.player.template.loop.innerHTML =
														r.default.loopNone))
												: "none" === this.player.options.loop
													? ((this.player.options.loop = "all"),
														(this.player.template.loop.innerHTML =
															r.default.loopAll))
													: "all" === this.player.options.loop &&
							...
							},
							{
								...
								value: function () {
									this.player.template.miniSwitcher.addEventListener(
										...
										() => {
											this.player.setMode(
												"mini" === this.player.mode ? "normal" : "mini",
											);
										},
									);
								},
									...
									if (!this.parsed[e])
										if (this.async) {
											...
											n.onreadystatechange = () => {
												e === this.player.list.index &&
													4 === n.readyState &&
													((n.status >= 200 && n.status < 300) ||
													304 === n.status
														? (this.parsed[e] = this.parse(n.responseText))
														: (this.player.notice(
							...
							},
							{
								...
								value: (e) => {
									if (e) {
										...
										return (
											(n = n.filter((e) => e[1])).sort((e, t) => e[0] - t[0]), n
										);
									}
									return [];
								},
					...
					return (
						i(e, [
							...
							},
							{
								key: "get",
								value: function (e, t) {
									return Number.parseFloat(this.elements[e].style[t]) / 100;
								},
							},
						]),
						e
						...
						i(e, [
							{
								...
								value: function () {
									...
									this.options.audio.length &&
										...
										(this.lrcWrap =
											this.container.querySelector(".aplayer-lrc")),
										(this.ptime =
											this.container.querySelector(".aplayer-ptime")),
										...
										(this.thumb =
											this.container.querySelector(".aplayer-thumb")),
										(this.volume =
										...
										(this.title =
											this.container.querySelector(".aplayer-title")),
										(this.author =
											this.container.querySelector(".aplayer-author")),
										(this.dtime =
											this.container.querySelector(".aplayer-dtime")),
										(this.notice =
			...
			(e, t, n) => {
				Object.defineProperty(t, "__esModule", { value: !0 }),
					(t.default = (e) => {
						...
						for (var n in t)
							Object.hasOwn(t, n) && !Object.hasOwn(e, n) && (e[n] = t[n]);
						return (
							...
							(d = d && d.setTimeout ? d : e),
								"[object process]" === {}.toString.call(e.process)
									...
									: !(() => {
										...
										? e.MessageChannel
											? (((r = new MessageChannel()).port1.onmessage = (e) => {
													y(e.data);
												}),
												(i = (e) => {
			...
			(e, t, n) => {
				...
				(t.setTimeout = function () {
					...
					(a.prototype.unref = a.prototype.ref = () => {}),
							...
							i(
								...
								[
									...
									},
									{
										...
										value: function () {
											this.on("play", () => {
												this.paused && this.setUIPlaying();
											}),
												this.on("pause", () => {
													this.paused || this.setUIPaused();
												}),
												this.on("timeupdate", () => {
													if (!this.disableTimeupdate) {
														...
														var t = r.default.secondToTime(
															this.audio.currentTime,
														);
														this.template.ptime.innerHTML !== t &&
															(this.template.ptime.innerHTML = t);
													}
												}),
												this.on("durationchange", () => {
													1 !== this.duration &&
														(this.template.dtime.innerHTML =
															r.default.secondToTime(this.duration));
												}),
												this.on("progress", () => {
													var t = this.audio.buffered.length
														? this.audio.buffered.end(
																this.audio.buffered.length - 1,
															) / this.duration
														: 0;
													this.bar.set("loaded", t, "width");
												});
											var t = void 0;
											this.on("error", () => {
												this.list.audios.length > 1
													? (this.notice(
														...
														(t = setTimeout(() => {
															this.skipForward(), this.paused || this.play();
														}, 2e3)))
													: 1 === this.list.audios.length &&
												...
												this.on("ended", () => {
													"none" === this.options.loop
														? "list" === this.options.order
															? this.list.index < this.list.audios.length - 1
																? (this.list.switch(
																		(this.list.index + 1) %
															...
															: "random" === this.options.order &&
																...
																this.randomOrder.length - 1
																	...
																	: (this.list.switch(this.nextIndex()),
																		this.pause()))
														: "one" === this.options.loop
															? (this.list.switch(this.list.index), this.play())
															: "all" === this.options.loop &&
																(this.skipForward(), this.play());
												});
										},
									},
									{
										...
										value: function () {
											if (
												(this.paused &&
													...
													setTimeout(() => {
														this.template.button.innerHTML = o.default.pause;
													}, 100),
									...
									},
									{
										...
										value: function () {
											...
											t &&
												t.catch((t) => {
													console.warn(t),
														"NotAllowedError" === t.name && this.setUIPaused();
												});
										},
									},
									{
										...
										value: function () {
											this.paused ||
												...
												(this.template.button.innerHTML = ""),
												setTimeout(() => {
													this.template.button.innerHTML = o.default.play;
												}, 100),
												(this.template.skipPlayButton.innerHTML =
													o.default.play)),
